    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <h2 class="all-booking-head"><a href="index.php">Home / </a>Check Out</h2>
            </div>
        </div>
    </div>
                        ...
                        <table class="table all-booking-table" cellspacing="0">
                            <thead>
                                <div class="table-query">
                                    <h3 class="table-title">Check Out</h3>
...
<?php 
   ...
   $shoDataQuery = "SELECT * FROM dashbord WHERE paid_unpaid='Paid' ";
...
$serialCount = 1;
    while ($db_data = mysqli_fetch_array($runDataQuery)) {
        ...
        $billNo = $db_data["billNo"];
?>   

                                <tr class="emran" >
                                    <input type="hiden" hidden="" value="<?php  ?>" name="">
                                    <td style="text-align: center; color:#716e6e9e;"><?php echo $serialCount++;?>.</td>
                                    ...
                                    <td style="padding:0px 10px;"><?php echo $billNo; ?></td>
                                    <td><?php echo $user_room_type; ?></td>
                                    <td style="display: none;"><?php echo $checkout_code; ?></td>
                                   
                                    <td>
                                        <a href="php-core/check_out_pdf.php?token=<?php echo $user_token; ?>&editB00kingActive&done" ><i class="fas fa-download booking-dtl-del"></i></a>
                                    </td>
                                </tr>
                                <tr>
